...
function displayCardsDynamically(collection) {
    ...
    // reordering collection by length field
    db.collection(collection).orderBy("length").get()   //the collection called "hikes"
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                // This call back arrow function will wait for saveBookmark 
...
function updateBookmark(hikeDocID) {
    ...
    .then(userDoc => {
        ...
        let isBookmarked = bookmarks.includes(hikeDocID); // Check if this id exists in bookmark array
